  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-5 py-10">
      <form
        ...
        className="w-full max-w-xl rounded-[28px] border border-[#e4e7ed] bg-white p-8 shadow-[0_20px_60px_rgba(30,35,55,0.08)]"
      >
        <div className="rounded-2xl bg-[#e9edff] px-4 py-3 text-sm font-medium text-[#4f6df5]">
          第一步 · 告诉 Metis 你的考试目标
        </div>
        ...
        <label className="mt-6 block text-sm font-medium text-[#3a3f4b]">
          预计考试日期
          <input
            type="date"
            value={examDate}
            ...
            className="mt-2 w-full rounded-2xl border border-[#e4e7ed] bg-[#fbfbfc] px-4 py-3 text-sm outline-none focus:border-[#4f6df5]"
          />
        </label>
        ...
        <button
          type="submit"
          disabled={busy}
          className="mt-7 w-full rounded-2xl bg-[#4f6df5] px-5 py-3 text-sm font-semibold text-white shadow-[0_10px_24px_rgba(79,109,245,0.24)] transition hover:-translate-y-0.5 disabled:opacity-60"
        >
